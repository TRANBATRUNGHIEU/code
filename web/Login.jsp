...
<html lang="en">
    <head>
       ...
       <style>
           body{
               background: url('https://www.thoughtco.com/thmb/C7RiS4QG5TXcBG2d_Sh9i4hFpg0=/3620x2036/smart/filters:no_upscale()/close-up-of-clothes-hanging-in-row-739240657-5a78b11f8e1b6e003715c0ec.jpg')top center / cover no-repeat;
           }
           .btn-signup,
           .btn-signin{
    ...
    <body>
        <div id="logreg-forms">
            <form class="form-signin" action="login" method="post">
                ...
                <hr>
                <button class="btn btn-signup btn-lg" type="button" id="btn-signup"> Sign up New Account</button>
            </form>
            ...
            <form action="signup" method="post" class="form-signup">
                ...
                <button class="btn btn-signup btn-lg" type="submit"></i> Sign Up</button>
