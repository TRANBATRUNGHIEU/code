...
<html lang="en">
    ...
    <body   background="black">
        <nav class="navbar navbar-expand-lg navbar-light bg-light flex-column" style="position: fixed; left: 20px;">
            <a class="navbar-brand" href="dashBoard"><img src="img/logo.PNG" width="200px" height="200px">
        ...
        <div class="container-xl" style="margin-left: 270px;">
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title manager-pro">
                        <div class="row">
                            <div class="col-sm-6">
        ...
        <div id="deleteEmployeeModal" class="modal fade">
         ...
         <a href="#addEmployeeModal" class="btn btn-dark" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Product</span></a>
    </body>
</html>